...
Here you can put some services, enums, models shared by several features, and it also contains the ViewModelBase. each category (i mean services, models, enums ect) should have own separated subfolder
