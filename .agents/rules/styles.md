...
* You can add new global and feature styles only if i directly tell to do so. For default yous should place all new styles in ScreenStyles of screen which will use this styles
